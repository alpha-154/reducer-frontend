  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        albasterbg: "#F1F0E8",   //application's bg colour
        albasterInnerBg: "#EBE9DF",  //application's inner component bg colour
        boneInnerBg: "#DED8C4",  //application's hover effect bg colour
        burntSienna: "#D87D5D", // button's bg colour
        burntSiennaDeep: "#E2714F", // button's hover effect bg colour      
        nightText: "#10100E", // application's secondary text colour
        brownText: "#535146", // application's primary text colour
        darkbrownText: "#3D3929", // application's secondary text colour
        cardBlueBg: "#E7E3F1",
